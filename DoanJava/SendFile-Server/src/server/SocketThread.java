...
public class SocketThread implements Runnable{
    ...
    private void createSingleChat(String receiver,String sender,String msg){
	    try {
        main.appendMessage("[createSingleChat]: create single chat connection");
        Socket s = main.getClientList(receiver);
        if (s!=null){ //client exist
            main.appendMessage("[createSingleChat]: Socket ok");
	        DataOutputStream dos = new DataOutputStream(s.getOutputStream());
	        //Format CMD_CHAT_SINGLE
	        String format = "CMD_CHAT_SINGLE "+sender+" "+receiver+" "+msg;
	        dos.writeUTF(format);
	        main.appendMessage("[createSingleChat]"+format);
        } else {
        	main.appendMessage("[createSingleChat]: Client was not found "+receiver);
        	DataOutputStream dataOutputStream = new DataOutputStream(s.getOutputStream());
        	dataOutputStream.writeUTF("CMD_CHAT_SINGLE_ERROR Client '"+receiver+"' was not found in list,make sure it is in online list!");
            }
        }
	    catch (IOException e) {
		    e.printStackTrace();
