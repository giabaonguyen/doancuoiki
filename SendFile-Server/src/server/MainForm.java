...
public class MainForm extends JFrame {
    ...
    /** Chat List  **/
    Vector socketList = new Vector();
    Vector clientList = new Vector();
    String groupName;
    Vector groupSocket = new Vector();
    Vector groupMemberList = new Vector();
	...
	public void setGroupMemberList(String groupMember){
		try{
			groupMemberList.add(groupMember);
			appendMessage("[setGroupMemberList]: Added");
		}
		catch (Exception e){
			appendMessage("[setGroupMemberList]: "+e.getMessage());
		}
	}
	public void appendGroup(String groupname,Socket socket){
		try{
			map.put(groupname,groupMemberList);
    ...
    public Socket getGroupSocket(String groupName){
		Socket gSocket = null;
		for (int i =0;i< map.size();i++){
			if (map.containsKey(groupName)){
				gSocket = (Socket) groupSocket.elementAt(i);
				break;
			}
		}
		return gSocket;
    ...
    public void setClientList(String client){
        try {
            ...
            appendMessage("[setClientList]: Added"+client);
